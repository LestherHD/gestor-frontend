...
export class UsuariosComponent implements OnInit {
  ...
  //     sucursal: new FormControl({value: this.formFiltros.controls.sucursal.value.toString().trim(), disabled: true}),
  ...
  //   const request = new UsuariosRequestDTO(null, null, null, null, null,  new Usuarios(idValue, usuarioValue, null, nombreValue,
  //     apellidoValue, correoValue, telefonoValue, this.listaSucursales ? this.listaSucursales.find(x => x.id = sucursalValue) : null, principalValue), pageValue, sizeValue);
  //
  ...
  //     apellido: new FormControl(item.apellido, Validators.required),
  //     telefono: new FormControl(item.telefono, Validators.required),
  //     correo: new FormControl(item.correo, Validators.required),
  ...
  //     apellido: new FormControl({value: item.apellido, disabled: true}, Validators.required),
